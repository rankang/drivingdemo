...
public class Frame {
    ...
    protected short HEADER_DEVICE_ID = 12;

    /**消息流水号 WORD 按发送顺序从0开始循环累加*/
    protected short HEADER_MSG_SEQUENCE = 0;

    /**消息包封装项 如果消息体属性中相关标识位确定消息分包处理，则该项有内容，否则无该项,
     * WORD 描述
     * */
    protected short HEADER_MSG_PACKAGE_COUNT = 11;

    /**
     * 包序号(word(16))  从 1 开始
     * */
    protected short HEADER_MSG_PACKAGE_SEQUENCE = 1;
